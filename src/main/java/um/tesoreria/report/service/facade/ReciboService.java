package um.tesoreria.report.service.facade;
...
import um.tesoreria.report.client.ChequeraCuotaClient;
import um.tesoreria.report.client.ChequeraFacturacionElectronicaClient;
import um.tesoreria.report.client.ChequeraSerieClient;
import um.tesoreria.report.client.FacturacionElectronicaClient;
import um.tesoreria.report.kotlin.model.client.tesoreria.core.*;
...
public class ReciboService {
    ...
    public String send(Long facturacionElectronicaId, FacturacionElectronicaDto facturacionElectronica) throws MessagingException {
        ...
        ChequeraSerieDto chequeraSerie = chequeraSerieClient.findByUnique(facturacionElectronica.getChequeraPago().getFacultadId(), facturacionElectronica.getChequeraPago().getTipoChequeraId(), facturacionElectronica.getChequeraPago().getChequeraSerieId());
        ChequeraPagoDto chequeraPago = facturacionElectronica.getChequeraPago();
